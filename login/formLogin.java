...
//					System.out.println(password);
					...
					datauser=data.getRowData(username); //ngambil username
...
//					System.out.println(datauser.size());
					...
					if(datauser.size()==0) {
						...
						for(int i=0;i<datauser.size();i++) {
							...
							tempMhs.add(datauser.get(i).getUsername());
							tempMhs.add(datauser.get(i).getPassword());
							
							System.out.println(datauser.get(i).getUsername());
							System.out.println(datauser.get(i).getPassword());
						}
